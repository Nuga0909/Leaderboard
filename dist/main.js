...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"POPULATE_BOARD\": () => (/* binding */ POPULATE_BOARD),\n/* harmony export */   \"POST_SCORE\": () => (/* binding */ POST_SCORE)\n/* harmony export */ });\n/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api */ \"./src/modules/api.js\");\n\n\nconst boardCont = document.querySelector('.score-cont');\n\nconst POPULATE_BOARD = async () => {\n  boardCont.innerHTML = '';\n  const scoreArr = await (0,_api__WEBPACK_IMPORTED_MODULE_0__.GET_SCORE)();\n  scoreArr.sort((a, b) => b.score - a.score);\n  scoreArr.forEach((element) => {\n    boardCont.innerHTML += `\n    <li>\n      <p class=\"name\">${element.user} </p>\n      <p class=\"score\">${element.score}</p>\n    </li>\n    `;\n  });\n};\n\nconst POST_SCORE = async (userInput) => fetch(_api__WEBPACK_IMPORTED_MODULE_0__.URL, {\n  method: 'POST',\n  headers: {\n    'content-type': 'application/json',\n  },\n  body: JSON.stringify(userInput),\n})\n  .then((response) => response.json())\n  .then((data) => data.result);\n\n\n\n//# sourceURL=webpack://webpack-config/./src/modules/populate.js?");
